...
function AboutUS() {
    return (
        ...
        <div className={Styles.content}>
            ...
            <p className={Styles.who}><strong>Who we are ?</strong><br/>
...
Medicover is one of the most respected healthcare brands in the world with presence in 12 countries across the globe - Germany, Sweden, Poland, Turkey, Belarus, Bulgaria, Georgia, Hungary, Romania, Serbia, Moldova, Ukraine and India.</p>
        <div className={Styles.highlights}>
            <p><strong>Our Highlights</strong></p>
            <ul className="high">
                <li>24 Hospitals</li>
                <li>125 Med Centers</li>
                <li>3000+ beds</li>
                <li>6 Million Medical Visits</li>
                <li>100+ Labs</li>
                <li>123000 Employees</li>
            </ul>
        </div>
        </div>
    )
