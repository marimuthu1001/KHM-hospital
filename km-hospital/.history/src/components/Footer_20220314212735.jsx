...
<hr/>
                ...
                <Row  className={Styles.social}>
                   <Col sm={{span:2}} md={{span:8}} lg={{span:8}}><a target="_blank" href="http://wa.me/919384592401"><WhatsAppOutlined style={{fontSize: '30px' }} /></a> </Col>
                    <Col sm={{span:2}} md={{span:8}} lg={{span:8}}><a target="_blank" href="http://wa.me/919384592401"><InstagramOutlined style={{fontSize: '30px' }} /></a></Col>
                    <Col sm={{span:2}} md={{span:8}} lg={{span:8}}><a target="_blank" href="http://wa.me/919384592401"><FacebookOutlined style={{fontSize: '30px' }} /></a></Col>
                </Row>
            </div>
        </div>
        </div>
