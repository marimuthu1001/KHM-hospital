        ...
        <div  >
            <div className={Styles.footer}>
                ...
                <Row className={Styles.design} gutter={[34, 18]}>
                    <Col sm={{ span: 3, offset: 0 }} md={{ span: 6, offset: 0 }} lg={{ span: 6, offset:0  }}> </Col>
                        <Col className={Styles.frontend} sm={{ span: 5, offset: 0 }} md={{ span: 6, offset: 0 }} lg={{ span: 6, offset: 0 }}>
                        <div >
                        ...
                        <Col className={Styles.backend} sm={{ span: 3, offset: 0 }} md={{ span: 6, offset: 0 }}  lg={{ span: 6, offset:0  }}>
                        <div >
                                <ul>
                        ...
                        <Col sm={{ span: 5, offset: 0 }} md={{ span: 6, offset: 0 }} lg={{ span: 6, offset:0  }}> </Col>
                </Row>
