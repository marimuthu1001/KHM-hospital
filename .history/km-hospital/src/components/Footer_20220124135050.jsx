        ...
        <div  >
            <div className={Styles.footer}>
                ...
                <Row  className={Styles.social}>
                    <Col sm={{span:4}} lg={{span:8}}><WhatsAppOutlined style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:4}} lg={{span:8}}><InstagramOutlined style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:4}} lg={{span:8}}><FacebookOutlined style={{fontSize: '30px' }} /></Col>
                </Row>
            </div>
        </div>
        </div>
