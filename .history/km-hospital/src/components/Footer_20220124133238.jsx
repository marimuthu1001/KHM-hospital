        ...
        <div  >
            <div className={Styles.footer}>
                ...
                <div className={Styles.footerContent}>
                    <div xs={1}  md={6} lg={8}  className={Styles.footerTitle}>
                ...
                <Row className={Styles.design} gutter={[34, 18]}>
                        <Col className={Styles.frontend} sm={{ span: 12, offset: 0 }} lg={{ span: 12, offset: 0 }}>
                        <div >
                        ...
                        <Col className={Styles.backend} sm={{ span: 12, offset: 0 }} lg={{ span: 12, offset: 0 }}>
                        <div >
