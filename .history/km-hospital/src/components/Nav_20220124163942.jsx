        ...
        <div className={Styles.head} >
            <Row gutters={[16,16]}>
              ...
              <div className={Styles.contactHead}>
                <p style={{color:'black'}}><PhoneFilled  style= {{ fontSize: '20px',color: '#007ff7'  }} />&nbsp;+91 95009 77257</p>
                <p><a href="mailto:infokmh@gmail.com"><MailFilled style= {{ fontSize: '20px',color: '#007ff7'  }} />&nbsp;infokmh@gmail.com</a></p>
               </div>
              </Col>
            </Row>
        </div>
