...
<hr/>
                ...
                <Row  className={Styles.social}>
                    <Col sm={{span:2}} md={{span:4}} lg={{span:8}}><WhatsAppOutlined style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:2}} lg={{span:4}}><InstagramOutlined style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:2}} lg={{span:4}}><FacebookOutlined style={{fontSize: '30px' }} /></Col>
                </Row>
            </div>
        </div>
        </div>
