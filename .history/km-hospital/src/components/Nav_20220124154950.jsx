    ...
    return (
      ...
      <Header className="header">
        ...
        <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['1']}>
          ...
          <Menu.Item key="2"><FolderOpenTwoTone/>About Us</Menu.Item>
          <Menu.Item key="3"><MedicineBoxTwoTone/>Hospitals</Menu.Item>
          <Menu.Item key="4"><PlusCircleTwoTone/>Specialities</Menu.Item>
          <Dropdown  overlay={patients} placement="topCenter">
              <Menu.Item key="5"><FireTwoTone/>For patients</Menu.Item>
          </Dropdown>
          <Menu.Item key="6"><MailTwoTone/>Contact Us</Menu.Item>
