...
import {WhatsAppOutpned,
    InstagramOutpned,
    FacebookOutpned} from '@ant-design/icons'
function Footer() {
    return (
        <div  >
...
<hr/>
                ...
                <Row  className={Styles.social}>
                    <Col sm={{span:2}} lg={{span:8}}><WhatsAppOutpned style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:2}} lg={{span:8}}><InstagramOutpned style={{fontSize: '30px' }} /></Col>
                    <Col sm={{span:2}} lg={{span:8}}><FacebookOutpned style={{fontSize: '30px' }} /></Col>
                </Row>
            </div>
        </div>
        </div>
