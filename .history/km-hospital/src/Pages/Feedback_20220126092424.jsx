...
console.log(loading)
    ...
    return (
        <div>
             ...
             <Row justify="space-around" align="middle" gutter={[6, 1]}>
                <Col justify="space-around" align="middle" span={4}>Doctors</Col>
                <Col span={4}>Book an appointment</Col>
                <Col span={4}>Health Checkup packages</Col>
                <Col span={4}>Second Opinion</Col>
                <Col span={4}>Diseases</Col>
                <Col span={4}>Medicines</Col>
            </Row>
