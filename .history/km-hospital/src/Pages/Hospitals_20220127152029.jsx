            ...
            <div className="site-card-wrapper">
                    <Row className={Styles.locations} justify="space-around" align="middle" gutter={28}>
                        ...
                        <Col  sm={{span:1}} md={{span:5}}  lg={{span:5}} >
                            <Card className={Styles.card} style={{backgroundColor:'whitesmoke'}} title="CHENNAI" bordered={true} hoverable={true}>
                            <img src={Img1} alt="Hospital"  width={240} height={200}/>
                            St.Thomas Mount,Chromepet, Tamil Nadu <br/> <PhoneFilled />+91 9012422355
                            </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}} >
                            <Card  className={Styles.card} style={{backgroundColor:'whitesmoke'}} title="COIMBATORE" bordered={true} hoverable={true}>
                            <img src={Img1} alt="Hospital"  width={240} height={200}/>
                           11th Street, Opp:, E Power House Rd,Near KFC <br/> <PhoneFilled />+91 9012422354
                            </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}}>
                            <Card className={Styles.card} style={{backgroundColor:'whitesmoke'}} title="SALEM" bordered={true} hoverable={true}>
                            <img src={Img1} alt="Hospital"  width={240} height={200}/>
                           Dalmia Board- Bangalore Highway, Salem  <br/> <PhoneFilled />+91 9012422353
                            </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}}>
                            <Card className={Styles.card} style={{backgroundColor:'whitesmoke'}} title="KANYAKUMARI" bordered={true} hoverable={true}>
                            <img src={Img1} alt="Hospital"  width={240} height={200}/>
