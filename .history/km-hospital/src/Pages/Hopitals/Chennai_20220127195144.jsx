...
function Chennai() {
    ...
    const refThree = firebase.firestore().collection("Hospitals_Chennai");
    ...
    return (
        <div>
            <h1 style={{textAlign: 'center'}}>Chennai Located Med Spaces</h1>
             <Row gutter={[90,30]}>  
                {hospitals.map((hospital)=>(
                   ...
                   <Card
                        ...
                        hoverable
                        style={{ width: 240 }}
                        cover={<img src={hospital.img} alt="svg" width="280" height="200"/>}
                    >
