        ...
        <div>
            ...
            <Form name="complex-form" onFinish={onFinish} labelCol={{ span: 10 }} wrapperCol={{ span: 8 }}>
                ...
                <div className={Styles.aboutContent}>
                    ...
                    <p>Here,<br/>
                            kg = Person’s weight in kilogrammes<br/>

                            m2 = Height in metres squared<br/>

                            To calculate your BMI, follow these steps:<br/>

                            Enter your age<br/>
                            Choose your gender<br/>
                            To obtain the best results, measure and enter your exact height and weight.<br/>
                            Type in your number<br/>
                            You will be given an OTP, which you must validate.<br/>
