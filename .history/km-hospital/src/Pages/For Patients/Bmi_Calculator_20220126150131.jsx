        ...
        <div>
            ...
            <Form name="complex-form" onFinish={onFinish} labelCol={{ span: 10 }} wrapperCol={{ span: 8 }}>
                ...
                <div className={Styles.aboutContent}>
                    ...
                    <div className={Styles.bmiFormula}>
                         <h1>BMI = Weight(kg)/[height(m)]²</h1>  
                    </div>  
                    <p><strong>Here,</strong><br/>
                            <DoubleRightOutlined /> kg = Person’s weight in kilogrammes<br/>
                            <DoubleRightOutlined />m2 = Height in metres squared<br/>
                            <DoubleRightOutlined />To calculate your BMI, follow these steps:<br/>
                            <DoubleRightOutlined />Enter your age<br/>
                            <DoubleRightOutlined />Choose your gender<br/>
                            <DoubleRightOutlined />To obtain the best results, measure and enter your exact height and weight.<br/>
                          <strong>Calculate your BMI</strong>  </p>
                          <h1>Understanding BMI Results</h1>
                                 <h3> <DoubleRightOutlined /> Less than 18.5 = Underweight<br/>
                                        <DoubleRightOutlined /> 18.5 to 24.9 = Healthy weight/ Normal BMI<br/>
                                       <DoubleRightOutlined />  25 to 29.9 = Overweight<br/>
                                       <DoubleRightOutlined />  30 or Higher = Obese</h3>
                            </div>
        </div>
    )
}
