            ...
            <div className="site-card-wrapper">
                    <Row className={Styles.locations} justify="space-around" align="middle" gutter={28}>
                        ...
                        <Col  sm={{span:1}} md={{span:5}}  lg={{span:5}} >
                            ...
                            <Button type="link" href='/hospitals/chennai' block>Visit</Button>
                            </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}} >
                           ...
                           <Button type="link" href='/hospitals/coimbatore' block>Visit</Button>
                         </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}}>
                           ...
                           <Button type="link" href='/hospitals/salem' block>Visit</Button>
                            </Card>
                        </Col>
                        <Col sm={{span:1}} md={{span:5}} lg={{span:5}}>
                            ...
                            <img src={Img4} alt="Hospital"  width={240} height={200}/>
                             ...
                             <Button type="link" href='/hospitals/kanyakumari' block>Visit</Button>
                           </Card>
                        </Col>
