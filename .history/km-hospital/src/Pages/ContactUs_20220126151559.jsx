...
function ContactUs() {
    const onFinish = (values) => {
        ...
        console.log('email:', values.mob_num);
        console.log('message:', values.feedback);
        const db = firebase.firestore();
            const userRef = db.collection("Feedback").add({
            username: values.username,
            mob_num:values.mob_num,
            feedback:values.feedback,
            }).then(alert('Mudinji pochi..!'));
      };
...
<Row justify="space-around" align="middle" gutter={8}>
        ...
        <Form className={Styles.form}
                    ...
                    <Form.Item
                        ...
                        {
                            required: true,
                            message: 'Let we know your Feedback!',
                        },
                        ]}
                    >
                        <Input />
        ...
        <Col span={5}>
        <img  src={TamilNadu} alt="TN map" width={150} height={190} />
        </Col>
</Row>
